...
const BLOCKS_TO_RENEW_VOUCHER = 1_200; // blocks to renew voucher if is expired
const INITIAL_VOUCHER_TOKENS = 2; // Initial tokens for new vouchers
const INITIAL_BLOCKS_FOR_VOUCHER = 1_200; // Initial blocks for voucher (one minute)
const MIN_NUM_OF_LETTERS_IN_NAME = 8;
const MIN_NUM_OF_LETTERS_IN_PASSWORD = 10;
                    ...
                    error={errors2.password?.message}
                    {
                        ...register2(
                            'password',
                            {
                                ...
                                minLength: {
                                    value: MIN_NUM_OF_LETTERS_IN_PASSWORD,
                                    message: `Minimum length is ${MIN_NUM_OF_LETTERS_IN_PASSWORD}`
                                }
                            }
                        )
                    }
                            ...
                            error={errors.password?.message}
                            {
                                ...register(
                                    'accountName',
                                    {
                                        required: 'Field is required',
                                        minLength: {
                                            value: MIN_NUM_OF_LETTERS_IN_NAME,
                                            message: `Minimum length is ${MIN_NUM_OF_LETTERS_IN_NAME}`
                                        }
                                    }
                                )
                            }
